...
Public Class global_report
    Private Sub global_report_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'HCQC_serverDataSet.report_global_view' table. You can move, or remove it, as needed.
        Me.Report_global_viewTableAdapter.Fill(Me.HCQC_serverDataSet.report_global_view)
    ...
    Private Sub global_report_Closed(sender As Object, e As EventArgs) Handles Me.Closed
