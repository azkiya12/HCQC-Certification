Public Class CheckIn1Count
    Private Sub Btn_save_ger_Click(sender As Object, e As EventArgs) Handles Btn_save_ger.Click
        ...
        If _isBOFAND("receipt", "labnum", tlabnumGer.Text) = True Then
            ...
            Else
                ...
                Dim result As Integer = MetroMessageBox.Show(Me, "Data " + tlabnumGer.Text + "sudah pernah di Check IN pada tanggal " + tgljln.ToString("dd-MM-yyyy") + " . Apakan anda ingin memperbaiki tanggal Test Sample?", "Germination Vigor", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, 211)
                If result = DialogResult.Yes Then
                    strIdreq = _DataToValue("SELECT id_request FROM receipt WHERE labnum='" & tlabnumGer.Text & "'")
    ...
    Private Sub BtnFindGer_Click(sender As Object, e As EventArgs) Handles BtnFindGer.Click
        ...
        If _isBOFAND("receipt", "labnum", tlabnumGer.Text) = True Then
            ...
            If _isBOFAND2("periodic_schedule", "labnum", tlabnumGer.Text, "[test_on]", "Germination Test") = False Then
                MetroMessageBox.Show(Me, "Anda melawatkan tahap untuk Check IN Germination Test atau Pengujian DT", "Germination Vigor", MessageBoxButtons.OK, MessageBoxIcon.Warning, 211)
                Return
            End If
            ...
            Else
                ...
                Dim result As Integer = MetroMessageBox.Show(Me, "Data sudah pernah di Upload pada tanggal " + tgljln.ToString("dd-MM-yyyy") + " . Apakan anda ingin memperbaharui tanggal Test Sample?", "Germination Vigor", MessageBoxButtons.YesNo, MessageBoxIcon.Information, 211)
                If result = DialogResult.Yes Then
    ...
    Private Sub tlabnumGer_KeyDown(sender As Object, e As KeyEventArgs) Handles tlabnumGer.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            tTestDateGer.Focus()
        End If
        'Console.WriteLine("tlabnum keydown")
    End Sub

    Private Sub tTestDateGer_KeyDown(sender As Object, e As KeyEventArgs) Handles tTestDateGer.KeyDown
        'Console.WriteLine("ttestdate keydown")
        If e.KeyCode = Keys.Enter Then
            If Btn_save_ger.Enabled = True Then
                Btn_save_ger_Click(sender, e)
                'Console.WriteLine("btn save ger call")
            Else
                BtnFindGer_Click(sender, e)
                'Console.WriteLine("btndinder call")
            End If
        End If
    End Sub
