...
Public Class MoistureTestRM
    Private Sub MoistureTestRM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'HCQC_serverDataSet.rm_msk' table. You can move, or remove it, as needed.
        Me.Rm_mskTableAdapter.FillBy(Me.HCQC_serverDataSet.rm_msk)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            _RunSQL("INSERT INTO rm_mt(no_lab, mr1, mr2, avrg, Dt_t, analys, tgl_input) VALUES('" & tno_lab.Text & "','" & Val(tmt1.Text) & "','" & Val(tmt2.Text) & "','" & Val(tmt_avrg.Text) & "','" & CDate(tTgl_mt.Text) & "','" & tanalys.Text & "','" & Now & "')")
            'Me.Wip_mt2TableAdapter.Fill(Me.H
            tno_lab.Focus()
            'Bersihkan()
        End If
    End Sub
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        _RunSQL("UPDATE rm_mt SET mr1 ='" & Val(tmt1.Text) & "', mr2 ='" & Val(tmt2.Text) & "', avrg ='" & Val(tmt_avrg.Text) & "', Dt_t ='" & CDate(tTgl_mt.Text) & "', analys ='" & tanalys.Text & "' WHERE (no_lab = '" & tno_lab.Text & "')")
    End Sub

    Private Sub MetroButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MetroButton2.Click
        Dim sql As String = ""
        openDB()
        sql = "Select * From rm_mt WHERE (no_lab= '" & tno_lab.Text & "')"
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        If result = DialogResult.Yes Then
            _RunSQL("DELETE FROM rm_mt WHERE(no_lab = '" & tno_lab.Text & "')")
            'Me.Wip_mt2TableAdapter.Fill(Me.HCQC_serverDataSet.wip_mt2)
            Me.tno_lab.Focus()
    ...
    Private Sub btnSave_FormClosed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
End Class