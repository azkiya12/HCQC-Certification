...
Public Class Data_List_Daya_Tumbuh

    Private Sub Data_List_Daya_Tumbuh_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub

    Private Sub Data_List_Daya_Tumbuh_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'HCQC_serverDataSet.Grafity_Dt' table. You can move, or remove it, as needed.
        Me.Grafity_DtTableAdapter.Fill(Me.HCQC_serverDataSet.Grafity_Dt)
        ''METROGRID1
