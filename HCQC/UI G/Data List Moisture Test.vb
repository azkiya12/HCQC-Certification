...
Imports System.Data
Public Class Data_List_Moisture_Test

    Private Sub Data_List_Moisture_Test_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub

    Private Sub Data_List_Moisture_Test_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'HCQC_serverDataSet.ListMt2' table. You can move, or remove it, as needed.
        Me.ListMt2TableAdapter.Fill(Me.HCQC_serverDataSet.ListMt2)
    ...
    Private Sub MetroButton1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles MetroButton1.Click
        Me.ListMt2TableAdapter.Fill(Me.HCQC_serverDataSet.ListMt2)
    End Sub
End Class