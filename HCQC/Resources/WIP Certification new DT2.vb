...
Public Class WIP_Certification_new_DT2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "WIP Certification new DT2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.WIP Certification new DT2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Nolab_rpt() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedWIP_Certification_new_DT2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WIP_Certification_new_DT2 = New WIP_Certification_new_DT2()
        rpt.Site = Me.Site
        Return rpt
    End Function
