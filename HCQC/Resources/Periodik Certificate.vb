...
Public Class Periodik_Certificate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Periodik Certificate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.Periodik Certificate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPeriodik_Certificate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Periodik_Certificate = New Periodik_Certificate()
        rpt.Site = Me.Site
        Return rpt
    End Function
