...
Public Class WIP_Certification
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.WIP Certification.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWIP_Certification
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WIP_Certification = New WIP_Certification()
        rpt.Site = Me.Site
        Return rpt
    End Function
