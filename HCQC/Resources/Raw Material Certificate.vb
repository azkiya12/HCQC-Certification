...
Public Class Raw_Material_Certificate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Raw Material Certificate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.Raw Material Certificate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRaw_Material_Certificate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Raw_Material_Certificate = New Raw_Material_Certificate()
        rpt.Site = Me.Site
        Return rpt
    End Function
