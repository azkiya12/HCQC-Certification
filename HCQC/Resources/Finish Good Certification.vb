...
Public Class Finish_Good_Certification
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Finish Good Certification.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.Finish Good Certification.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NoLab() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFinish_Good_Certification
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Finish_Good_Certification = New Finish_Good_Certification()
        rpt.Site = Me.Site
        Return rpt
    End Function
