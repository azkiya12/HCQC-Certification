...
Public Class Lead_Time_External

    Private Sub Lead_Time_External_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Me.Theme = My.Settings.tema
        Me.MetroStyleManager1.Theme = My.Settings.tema
    End Sub

    Private Sub Lead_Time_External_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'HCQC_serverDataSet.extrnl_leadtime' table. You can move, or remove it, as needed.
        Me.Extrnl_leadtimeTableAdapter.Fill(Me.HCQC_serverDataSet.extrnl_leadtime)
    ...
    Private Sub MetroGrid1_DataBindingComplete(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewBindingCompleteEventArgs) Handles MetroGrid1.DataBindingComplete
        'Hightlight list with specific character
