...
Public Class MoinstureTestFG
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            _RunSQL("INSERT INTO fg_mt(no_lab, mr1, mr2, avrg, Dt_t, analys, tgl_input) VALUES('" & tno_lab.Text & "','" & Val(tmt1.Text) & "','" & Val(tmt2.Text) & "','" & Val(tmt_avrg.Text) & "','" & CDate(tTgl_mt.Text) & "','" & tanalys.Text & "','" & Now & "')")
    ...
    Private Sub btnEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        _RunSQL("UPDATE fg_mt SET mr1 ='" & Val(tmt1.Text) & "', mr2 ='" & Val(tmt2.Text) & "', avrg ='" & Val(tmt_avrg.Text) & "', Dt_t ='" & CDate(tTgl_mt.Text) & "', analys ='" & tanalys.Text & "' WHERE (no_lab = '" & tno_lab.Text & "')")
    ...
    Private Sub MetroButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MetroButton2.Click
        Dim sql As String = ""
        openDB()
        sql = "Select * From fg_mt WHERE (no_lab= '" & tno_lab.Text & "')"
        ...
        If dread.Read = False Then
            openDB()
            sql = "Select * From fg_id WHERE (no_lab= '" & tno_lab.Text & "')"
            cmd = New SqlClient.SqlCommand(sql, con)
            cmd.CommandType = CommandType.Text
            cmd.CommandText = sql
            dread = cmd.ExecuteReader
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        If result = DialogResult.Yes Then
            _RunSQL("DELETE FROM fg_mt WHERE(no_lab = '" & tno_lab.Text & "')")
            'Me.Wip_mt2TableAdapter.Fill(Me.HCQC_serverDataSet.wip_mt2)
            Me.tno_lab.Focus()
