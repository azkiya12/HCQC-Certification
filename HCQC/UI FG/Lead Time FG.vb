...
Public Class Lead_Time_FG
    ...
    End Sub
    Private Sub Lead_Time_FG_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'HCQC_serverDataSet.fg_leadtime' table. You can move, or remove it, as needed.
        Me.Fg_leadtimeTableAdapter.Fill(Me.HCQC_serverDataSet.fg_leadtime)
