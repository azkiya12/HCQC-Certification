...
Partial Class Sample_Test_Control_FG
    ...
    Private Sub InitializeComponent()
        ...
        Me.MetroToolTip1.SetToolTip(Me.MetroButton1, "Untuk mengkosongkan/tanggal yang sudah ada sesuai Lab No.")
