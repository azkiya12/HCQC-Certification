...
Public Class Sample_Test_Control_P

    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        Try
            Dim sql As String = ""
            openDB()
            sql = "Select no_lab,test_date  From periodik_msk WHERE (no_lab= '" & tnolab.Text & "')"
            ...
            If dread.Read = True Then
                If IsDBNull(dread.Item("test_date")) Then
                    _RunSQL("UPDATE periodik_msk SET test_date='" & CDate(Tdate.Text) & "' WHERE (no_lab='" & tnolab.Text & "')")
                    Me.tnolab.Focus()
                Else
    ...
    Private Sub MetroButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MetroButton1.Click
        Try
            ...
            If dread.Read = True Then
                ...
                If result = DialogResult.Yes Then
                    _RunSQL("UPDATE periodik_msk SET test_date=null WHERE (no_lab='" & tnolab.Text & "')")
                    Me.tnolab.Focus()
                ElseIf result = DialogResult.No Then
                    Me.tnolab.Focus()
                End If
